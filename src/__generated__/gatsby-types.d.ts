...
type FileFieldsEnum =
  ...
  | 'childMarkdownRemark.frontmatter.environment'
  | 'childMarkdownRemark.frontmatter.isMobileMain'
  | 'childMarkdownRemark.frontmatter.mainImage'
  | 'childMarkdownRemark.frontmatter.number'
  | 'childMarkdownRemark.frontmatter.slug'
  | 'childMarkdownRemark.frontmatter.tags'
  | 'childMarkdownRemark.frontmatter.thumbnail'
  | 'childMarkdownRemark.frontmatter.title'
  | 'childMarkdownRemark.frontmatter.tool'
  ...
  | 'childrenMarkdownRemark.frontmatter.environment'
  | 'childrenMarkdownRemark.frontmatter.isMobileMain'
  | 'childrenMarkdownRemark.frontmatter.mainImage'
  | 'childrenMarkdownRemark.frontmatter.number'
  ...
  | 'childrenMarkdownRemark.frontmatter.tool'
...
type MarkdownRemarkFrontmatter = {
  ...
  readonly description: Maybe<Scalars['String']>;
  readonly environment: Maybe<ReadonlyArray<Maybe<Scalars['String']>>>;
  readonly isMobileMain: Maybe<Scalars['Boolean']>;
  ...
  readonly tool: Maybe<ReadonlyArray<Maybe<Scalars['String']>>>;
...
type MarkdownRemarkFrontmatterFilterInput = {
  ...
  readonly isMobileMain: InputMaybe<BooleanQueryOperatorInput>;
...
type BlogIndexQuery = { readonly site: { readonly siteMetadata: { readonly title: string | null } | null } | null, readonly allMarkdownRemark: { readonly totalCount: number, readonly edges: ReadonlyArray<{ readonly node: { readonly id: string, readonly excerpt: string | null, readonly frontmatter: { readonly title: string | null, readonly date: string | null, readonly tags: ReadonlyArray<string | null> | null, readonly slug: string | null, readonly thumbnail: string | null, readonly number: string | null } | null } }> } };
